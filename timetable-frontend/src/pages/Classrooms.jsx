      ...
      <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {classrooms.map((c) => (
            <div
              key={c.id}
              className="flex justify-between bg-white shadow-lg rounded-xl p-4 hover:shadow-2xl transition-shadow duration-300"
            >
              <div>
                <h2 className="font-semibold text-gray-700 text-lg">{c.name}</h2>
                <p className="text-gray-500">{c.capacity} seats</p>
              </div>
              <div className="bg-red-500 px-3 py-3 text-white p-2 rounded hover:bg-red-600">
